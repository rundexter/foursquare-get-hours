...
var globalPickResult = {
    'response.hours.timeframes': {
        key: 'result_hours_open',
        fields: {
            'days': 'days',
            'open': 'open'
        }
    },
    'response.popular.timeframes': {
        key: 'result_popular_open',
        fields: {
            'days': 'days',
            'open': 'open'
        }
